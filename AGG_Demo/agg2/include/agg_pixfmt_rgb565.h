...
namespace agg
{
    ...
    public:
            ...
            do
            {
                ...
                if(alpha)
                {
                    ...
                    else
                    {
                        ...
                        int g = (rgb >> 3) & 0xFC;
                        int b = (rgb << 3) & 0xF8;
                        *(int16u*)p = (((((c.r - r) * alpha) + (r << 16)) >> 8) & 0xF800) |
                                      (((((c.g - g) * alpha) + (g << 16)) >> 13) & 0x7E0) |
                                       ((((c.b - b) * alpha) + (b << 16)) >> 19);
                    }
                }
                               ...
                               const color_type* colors, const int8u* covers)
        {
            ...
            do
            {
                int alpha = covers ? (*covers++) * colors->a : 255 * colors->a;
                if(alpha)
                {
                    if(alpha == 255*255)
                    {
                    ...
                    else
                    {
                        ...
                        int g = (rgb >> 3) & 0xFC;
                        int b = (rgb << 3) & 0xF8;
                        *p = (((((colors->r - r) * alpha) + (r << 16)) >> 8) & 0xF800) |
            ...
            do
            {
                ...
                if(alpha)
                {
                    ...
                    else
                    {
                        ...
                        int g = (rgb >> 3) & 0xFC;
                        int b = (rgb << 3) & 0xF8;
                        *(int16u*)p = (((((colors->r - r) * alpha) + (r << 16)) >> 8) & 0xF800) |
                                      (((((colors->g - g) * alpha) + (g << 16)) >> 13) & 0x7E0) |
                                       ((((colors->b - b) * alpha) + (b << 16)) >> 19);
                    }
                }
