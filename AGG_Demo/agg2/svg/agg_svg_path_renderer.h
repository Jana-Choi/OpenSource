...
namespace svg
{
    ...
    struct path_attributes
    {
        ...
        bool                    stroke_flag;
        bool                    even_odd_flag;
        gen_stroke::line_join_e line_join;
        gen_stroke::line_cap_e  line_cap;
        double                  miter_limit;
        double                  stroke_width;
        ...
        path_attributes() :
            ...
            stroke_flag(false),
            even_odd_flag(false),
            line_join(gen_stroke::miter_join),
            line_cap(gen_stroke::butt_cap),
            miter_limit(4.0),
            stroke_width(1.0),
            transform()
        {
    ...
    public:
        ...
        void line_join(gen_stroke::line_join_e join);
        void line_cap(gen_stroke::line_cap_e cap);
        ...
        // affine_matrix and opacity. They can be used to transform the whole
        // image and/or to make it translucent.
        template<class Rasterizer, class Scanline, class Renderer> 
        void render(Rasterizer& ras, 
                    Scanline& sl,
                    Renderer& ren, 
                    const affine_matrix& mtx, 
                    const rect& cb,
                    double opacity=1.0)
        {
            unsigned i;
