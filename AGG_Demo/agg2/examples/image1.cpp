...
public:
    ...
    virtual void on_draw()
    {
        ...
        src_mtx *= agg::translation_matrix(-initial_width()/2 - 10, -initial_height()/2 - 20 - 10);
        src_mtx *= agg::rotation_matrix(m_angle.value() * agg::pi / 180.0);
        src_mtx *= agg::scaling_matrix(m_scale.value());
        src_mtx *= agg::translation_matrix(initial_width()/2, initial_height()/2 + 20);
        src_mtx *= resizing_matrix();

        agg::affine_matrix img_mtx;
        img_mtx *= agg::translation_matrix(-initial_width()/2 + 10, -initial_height()/2 + 20 + 10);
        img_mtx *= agg::rotation_matrix(m_angle.value() * agg::pi / 180.0);
        img_mtx *= agg::scaling_matrix(m_scale.value());
        img_mtx *= agg::translation_matrix(initial_width()/2, initial_height()/2 + 20);
