...
public:
    the_application(agg::pix_format_e format, bool flip_y) :
        ...
        m_idx(-1),
        m_join(10.0, 10.0, 130.0, 80.0, !flip_y),
        m_cap(10.0, 80.0 + 10.0, 130.0, 80.0 + 80.0, !flip_y),
    ...
    virtual void on_draw()
    {
        ...
        if(m_join.cur_item() == 1)   join = agg::gen_stroke::round_join;
        if(m_join.cur_item() == 2)   join = agg::gen_stroke::bevel_join;
