...
public:
    ...
    virtual void on_draw()
    {
        ...
        if(m_cap.cur_item() == 1)   cap = agg::gen_stroke::square_cap;
        if(m_cap.cur_item() == 2)   cap = agg::gen_stroke::round_cap;
        ...
        agg::conv_dash<agg::conv_curve<agg::conv_smooth_poly1<agg::path_storage> >, agg::gen_markers_term> dash(curve);
        agg::conv_stroke<agg::conv_dash<agg::conv_curve<agg::conv_smooth_poly1<agg::path_storage> >, agg::gen_markers_term> > stroke(dash);
        stroke.line_cap(cap);
        ...
        agg::conv_marker<agg::gen_markers_term, agg::arrowhead> arrow(dash.markers(), ah);
