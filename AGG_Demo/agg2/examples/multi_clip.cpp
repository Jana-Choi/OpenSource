...
namespace agg
{
    ...
    template<> struct gradient_linear_color<rgba8, 8>
    {
        ...
        {
            color_type c;
            c.r = (((m_c2.r - m_c1.r) * int(v)) + (m_c1.r << 8)) >> 8;
            c.g = (((m_c2.g - m_c1.g) * int(v)) + (m_c1.g << 8)) >> 8;
            c.b = (((m_c2.b - m_c1.b) * int(v)) + (m_c1.b << 8)) >> 8;
            c.a = (((m_c2.a - m_c1.a) * int(v)) + (m_c1.a << 8)) >> 8;
            return c;
        }
    ...
    template<> struct gradient_linear_color<gray8, 8>
    {
        ...
        {
            color_type c;
            c.v = (((m_c2.v - m_c1.v) * int(v)) + (m_c1.v << 8)) >> 8;
            c.a = (((m_c2.a - m_c1.a) * int(v)) + (m_c1.a << 8)) >> 8;
            return c;
        }
...
//}
        ...
        for(i = 0; i < 50; i++)
        {
            ...
            double r = rand() % 10 + 5;
            grm.reset();
            grm *= agg::scaling_matrix(r / 10.0);
            grm *= agg::translation_matrix(x, y);
            grm.invert();
