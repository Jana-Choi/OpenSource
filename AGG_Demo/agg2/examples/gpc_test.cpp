...
public:
    ...
    void perform_rendering(Scanline& sl, Ras& ras, Ren& ren, Gpc& gpc)
    {
        if(m_operation.cur_item() > 0)
        {
            ...
            txt_stroke.line_cap(agg::gen_stroke::round_cap);
            txt.size(10.0);
    ...
    unsigned render_gpc(Scanline& sl, Ras& ras)
    {
        ...
        switch(m_polygons.cur_item())
        {
            ...
            case 2:
            {
                ...
                agg::affine_matrix mtx2;
                mtx1 *= agg::translation_matrix(-1150, -1150);
                mtx1 *= agg::scaling_matrix(2.0);

                mtx2 = mtx1;
                mtx2 *= agg::translation_matrix(m_x - initial_width()/2, 
            ...
            case 3:
            {
                ...
                mtx *= agg::translation_matrix(-1150, -1150);
                mtx *= agg::scaling_matrix(2.0);
            ...
            case 4:
            {
                ...
                agg::affine_matrix mtx;
                mtx *= agg::scaling_matrix(4.0);
                mtx *= agg::translation_matrix(220, 200);
